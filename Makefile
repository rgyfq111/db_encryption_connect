srcdir = /home/php-5.5.11/ext/uitox_db
builddir = /home/php-5.5.11/ext/uitox_db
top_srcdir = /home/php-5.5.11/ext/uitox_db
top_builddir = /home/php-5.5.11/ext/uitox_db
EGREP = /bin/grep -E
SED = /bin/sed
...
RE2C = exit 0;
AWK = gawk
shared_objects_uitox_db = uitox_db.lo clib.lo
PHP_PECL_EXTENSION = uitox_db
PHP_MODULES = $(phplibdir)/uitox_db.la
PHP_ZEND_EX =
...
prefix = /usr/local/php
phplibdir = /home/php-5.5.11/ext/uitox_db/modules
